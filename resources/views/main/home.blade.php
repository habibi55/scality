  ...
  <div class="flex w-full gap-4">
    <div class="flex flex-col w-8/12 gap-4">
      ...
      <div class="rounded-xl bg-white">
          @if (empty($jadwal_absen))
          <div class="flex flex-col h-40 bg-white rounded-xl justify-center items-center text-3xl font-bold">
            <svg class="h-20 stroke-2 fill-primary" id="Layer_1" style="enable-background:new 0 0 128 128;" version="1.1" viewBox="0 0 128 128" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">
    ...
    {{-- Rapor Diri --}}
    <div class="w-4/12 rounded-xl bg-white h-full">
