      ...
      <div class="w-2/4 rounded-xl bg-white">
        ...
        <div class="flex flex-col p-5 gap-2">
          <div class="flex items-center gap-3">
            ...
            <div class="text-2xl font-semibold">{{ $jadwal_absen->judul }}</div>
          </div>
          ...
          <div class="flex flex-col gap-3">
            <div class="flex flex-col gap-1">
              ...
              <div class="flex items-center gap-1">
                ...
                <div class="text-lg font-semibold">{{ $jadwal_absen->tempat }}</div>
              </div>
            </div>
    ...
    <div class="flex flex-col p-5 gap-2">
      <div class="flex items-center gap-3">
        ...
        @foreach ($absen as $absen)
            <img src="/images/{{ $absen->image }}" width="500px">
            {{-- <img src="{{ asset('storage/images/'.$absen->image) }}" style="height: 50px;width:100px;"> --}}
        @endforeach
