<aside
  ...
  <div class="flex flex-col h-5/6 gap-2 mt-2 ">
    <div class="flex flex-col gap-2 font-semibold">
      ...
      @if(auth()->user()->role == 0)
        ...
        <a href="{{ route('profile-pengurus') }}" class="nav">
        ...
        <a href="{{ route('logout') }}" class="nav">
          <svg class="w-12" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"><rect fill="none" height="256" width="256"/><polyline fill="none" points="174 86 216 128 174 170" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><line fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" x1="104" x2="216" y1="128" y2="128"/><path d="M104,216H48a8,8,0,0,1-8-8V48a8,8,0,0,1,8-8h56" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/></svg>
      ...
      {{-- NAV EVALUATOR --}}
      @if(auth()->user()->role == 1)
        <a href="{{ route('home-evaluator') }}">
          <img class="w-36 mx-auto mb-4" src="{{ asset('/assets/images/scality rebranding.png') }}" alt="Logo">
        </a>

        <a href="{{ route('home-evaluator') }}" class="nav">
          <svg class="w-10" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            <title />
            <g id="home">
              <path
        ...
        <a href="{{ route('profile-evaluator') }}" class="nav">
          <svg class="w-9 mr-1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            <title />
            <g id="about">
              <path d="M16,16A7,7,0,1,0,9,9,7,7,0,0,0,16,16ZM16,4a5,5,0,1,1-5,5A5,5,0,0,1,16,4Z" />
      ...
      @if(auth()->user()->role == 2)
        ...
        <a href="{{ route('home-admin') }}" class="nav">
          <svg class="w-10" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            <title />
            <g id="home">
              <path
  ...
  <!-- Profile -->
  {{-- <div class="w-full flex flex-row bg-primary_back rounded-md h-20 items-center justify-center p-1 gap-4 text-sm">
    <svg class="w-4/12 h-14" 
    ...
    <div class="w-8/12 flex items-center font-bold text-black text-sm h-full">
      {{ Auth::user()->name }}
    </div>
  </div> --}}

  <div class="w-full flex flex-row bg-primary_back rounded-md min-h-20 items-center justify-center py-2 text-sm">
    <svg class="w-4/12 h-14" 
      data-dropdown-placement="top" data-te-dropdown-toggle-ref aria-expanded="false" data-te-ripple-init
      data-te-ripple-color="light" width="100%" height="100%" viewBox="0 0 61.7998 61.7998"
      xmlns="http://www.w3.org/2000/svg">
